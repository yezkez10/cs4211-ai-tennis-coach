...
The system is implemented in Node.js and integrates an LLM (GPT-4o or Gemini 1.5 Pro) for natural language understanding and tool orchestration, a player statistics database for real match data, and PAT for formal verification. The primary interface is a CLI, with a parametric PCSP# tennis tiebreak model at its core that accepts injected player statistics as parameters.
x
